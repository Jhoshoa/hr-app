...
interface DisableTenantMembershipUseCaseInput {
...
@Injectable()
export class DisableTenantMembershipUseCase {
  constructor(
  ...
  execute = async (input: DisableTenantMembershipUseCaseInput): Promise<TenantUserEntity> => {
